...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <applicationVisibilities>
        <application>MB_Operations</application>
    ...
    <classAccesses>
        <apexClass>DeliveryEditerController</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>DeliveryEditerTest</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>DeliveryEditerTestDataFactory</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>createInvoice</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>updatePub</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <custom>false</custom>
    <fieldPermissions>
    ...
    <fieldPermissions>
        <editable>false</editable>
        <field>Account.Current_Balance__c</field>
    ...
    <fieldPermissions>
        <editable>false</editable>
        <field>Account.Purchase_Discount__c</field>
        <readable>false</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <fieldPermissions>
        <editable>false</editable>
        <field>Account.Sale_Discount__c</field>
        <readable>false</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <fieldPermissions>
        <editable>false</editable>
        <field>OpportunityLineItem.Pick_Up__c</field>
        <readable>false</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>false</editable>
    ...
    <layoutAssignments>
        <layout>JobTracker-ジョブトラッカーレイアウト - Winter %2716</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>WorkFeedbackQuestion-フィードバック質問レイアウト - Winter %2716</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>WorkFeedbackQuestionSet-フィードバック質問セットレイアウト - Winter %2716</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>WorkFeedbackRequest-フィードバック要求レイアウト - Winter %2716</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>WorkFeedbackTemplate-Feedback Template Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>WorkPerformanceCycle-パフォーマンスサイクルレイアウト - Winter %2716</layout>
    </layoutAssignments>
    <objectPermissions>
    ...
    <pageAccesses>
        <apexPage>DeliveryEditer</apexPage>
        <enabled>false</enabled>
    </pageAccesses>
